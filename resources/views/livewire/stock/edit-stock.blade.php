<div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8">
    <div class="mb-8 text-3xl font-bold text-gray-800 border-b pb-4">Modifier Matériel</div>
    <form wire:submit.prevent="save" class="space-y-8">
        ...
        <div>
            ...
            <textarea id="commentaire" wire:model="commentaire"
                class="mt-2 w-full rounded-lg border border-gray-300 bg-gray-50 p-3 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50"
                rows="4" placeholder="Ajouter un commentaire ici..."></textarea>
        </div>

        <!-- Actions -->
        <div class="mt-6 text-right">
            <button type="submit"
                class="inline-flex items-center px-6 py-3 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75">
                <i class="fas fa-save mr-2"></i> Enregistrer
            </button>
            <button type="button"
                class="ml-4 inline-flex items-center px-6 py-3 bg-gray-200 text-gray-700 font-semibold rounded-lg shadow-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-75"
                wire:click="stock">
