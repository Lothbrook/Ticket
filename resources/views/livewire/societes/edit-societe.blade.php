<div class="max-w-xl">
    <div class="mb-5 text-2xl font-bold">Modifier Société</div>
    <form wire:submit.prevent="save" class="space-y-5">
        <div>
            <label for="name" class="mb-1 block text-sm font-medium text-gray-700 after:ml-0.5 after:text-red-500 after:content-['*']">Nom de société</label>
