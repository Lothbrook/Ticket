<div class="max-w-xl">
    <div class="mb-5 text-2xl font-bold">Ajouter catégorie de stock</div>
    <form wire:submit.prevent="save" class="space-y-5">
        <div>
            ...
            <input type="text" id="nom_categorie" wire:model="nom_categorie" @class([
                ...
                'border-red-300 focus:border-red-300 focus:ring-red-200' => $errors->has('nom_categorie'),
